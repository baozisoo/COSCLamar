...
public class Lab8MultiDimArrays {

	public static void main(String[] args) {
		Scanner input = new Scanner(System.in);
		
		//prompt 3 by 4 matrix from user
		...
		for (int column = 0; column < matrix[0].length; column++) {
			...
			System.out.println("Sum of the elements in column "+ column + ": " + totalColumn);
		}
